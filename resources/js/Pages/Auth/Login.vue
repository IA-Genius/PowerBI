...
<template>
    <GuestLayout>
        ...
        <div class="tituloPrincipal">Panel Ejecutivo de Inteligencia de Negocios</div>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                <InputLabel for="password" value="Contraseñas" class="colorMorado" />
            ...
            <div class="mt-4 center boxBtnl">
                ...
                <svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
                    ...
                    <g class="eyeL" data-svg-origin="85.5 78.5" transform="matrix(1,0,0,1,0,0)" style="">
                        <circle cx="85.5" cy="78.5" r="3.5" fill="#3a5e77"></circle>
                        <circle cx="84" cy="76" r="1" fill="#fff"></circle>
                    </g>
                    <g class="eyeR" data-svg-origin="114.5 78.5" transform="matrix(1,0,0,1,0,0)" style="">
