    ...
    <div class="min-h-screen bg-gray-100 flex">
        ...
        <aside
            :class="[
                ...
                'bgPrincipal customMenu fixed inset-y-0 left-0 z-50 bg-white shadow-lg flex flex-col transition-transform duration-300 ease-in-out',
                mobileSidebarOpen
                    ? 'translate-x-0'
        ...
        >
            ...
            <nav class="flex-1 overflow-y-auto py-2 space-y-1">
                ...
                >
                    <!-- <svg
                        class="h-6 w-6 text-white-500 svgMenu"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    >
                ...
                <div class="px-3">
                    <label
                        ...
                        class="block text-xs text-white-500 mt-4 mb-2"
                    >
                    ...
                    <ul v-if="reportesFiltrados.length" class="space-y-1">
                        <li v-for="r in reportesFiltrados" :key="r.id">
                            <div class="relative group tooltips">
                                ...
                                <div class="invisible absolute opacity-0 transition-opacity duration-300 group-hover:visible group-hover:opacity-100 left-full top-1/2">
                                    <div class="bgPrincipal whitespace-nowrap rounded-lg">
                                        {{ r.nombre }}
                                    </div> 
                                </div>
                            </div>
