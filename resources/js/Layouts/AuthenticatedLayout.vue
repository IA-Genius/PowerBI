...
<template>
    <div class="min-h-screen bg-gray-100 flex">
        ...
        >
            <div class="w-64 h-full bg-white shadow-lg flex flex-col menuColapsable">
                ...
                <nav class="flex-1 overflow-y-auto">
                    ...
                    <NavLink 
                        :href="route('gestionarReportes')" 
                        :active="route().current('gestionarReportes')"
                        class="flex items-center px-4 py-3 hover:bg-gray-100"
                    >
                        <svg class="h-7 w-7 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <NavLink 
                        :href="route('gestionarUsuarios')" 
                        :active="route().current('gestionarUsuarios')"
                        class="flex items-center px-4 py-3 hover:bg-gray-100"
                    >
